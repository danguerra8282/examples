    ...
    switch ($operation) {
        "add" {
            ...
            if ($allowInherit) {
                ...
                # $ace.AceFlags = 0 # This option is for only the top level permission set (non-propogated)
                $ace.AceFlags = 2   # This forces it to include all sub-folders/sub-objects
            }
